...
class VerificationRLAgent:
    ...
    # Update Q-value based on reward received
        ...
        if reward == -5:
            print("Critical security breach: False positive detected!")
...
def verify_vault(user_id):
    ...
    thresholds = np.linspace(0.7, 0.9, 5)  # Ensure threshold stays high enough for security
    state = 2  # Initial state (middle threshold)
